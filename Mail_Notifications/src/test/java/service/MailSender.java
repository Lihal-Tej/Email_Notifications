...
//	 
	...
	public static void main(String[] args) {
		 String host = "smtp.gmail.com";
	        ...
	        String password = "simtech@1234";
	 
	        // message info
	        String mailTo = "kopparapulihaltej.46@gmail.com";
	        String subject = "Simtech Mail Notification";
	        String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
	        String message = "Last Updated Time "+timeStamp;
	 
	        // attachments
	        String attachFiles = "C:\\Work\\eclipse-workspace\\Mail_Images\\Image2020.07.20.15.16.33.png";
